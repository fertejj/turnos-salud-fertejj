...
export default function EditMedicalHistoryPage() {
  ...
  return (
    <div className="max-w-3xl mx-auto px-4 py-8">
      <h1 className="text-2xl font-semibold text-primary mb-6">Editar entrada de historia clínica</h1>
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
        ...
        {/* Campos obligatorios */}
        {[{ name: "reason", label: "Motivo de la consulta" }, { name: "symptoms", label: "Síntomas" }].map(
          ({ name, label }) => (
            <div key={name}>
